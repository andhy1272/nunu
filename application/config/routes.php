...
$route['attention'] = 'attention/create';
...
//list[parameter, in this case the name of the page in /application/views/patients/list.php]   
////$route['patients/(:any)'] = 'patients/$1/$1';
